 ...
 * 
 * @property-read \App\Models\Receiving $receiving
 ...
 * @method static \Database\Factories\ReceivingItemFactory factory($count = null, $state = [])
 * 
 * @mixin \Eloquent
 */
class ReceivingItem extends Model
{
    ...
    /**
     * Get the receiving that owns the item.
     */
